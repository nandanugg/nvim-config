...
vim.keymap.set("n", "<C-g><C-e>", "<Cmd>FzfLua git_branches<CR>", opts)
vim.keymap.set("n", "]h", "<cmd>Gitsigns next_hunk<CR>", {})
vim.keymap.set("n", "[h", "<cmd>Gitsigns prev_hunk<CR>", {})
-- diffview (change)
vim.keymap.set("n", "<leader>cc", ":DiffviewOpen<CR>", opts)
vim.keymap.set("n", "<leader>cm", git.open_default_branch_diff, opts)
vim.keymap.set("n", "<leader>cq", ":DiffviewClose<CR>", opts)
vim.keymap.set("n", "<leader>cbf", ":DiffviewFileHistory %<CR>", opts)
vim.keymap.set("n", "<leader>cba", ":DiffviewFileHistory<CR>", opts)
