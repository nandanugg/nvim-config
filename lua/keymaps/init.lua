...
vim.keymap.set("n", "<leader>te", function() neotest.output_panel.toggle() end,              { noremap = true })
vim.keymap.set("n", "<leader>td", function() neotest.run.run({ nil, strategy = "dap" }) end, { noremap = true })

-- debugging
vim.keymap.set("n", "<C-x><C-s>", function() require("dap").continue() end)
vim.keymap.set("n", "<C-x><C-n>", function() require("dap").step_over() end)
vim.keymap.set("n", "<C-x><C-i>", function() require("dap").step_into() end)
vim.keymap.set("n", "<C-x><C-o>", function() require("dap").step_out() end)
vim.keymap.set("n", "<C-x><C-q>", function() require("dap").terminate() end)
...
vim.keymap.set("n", "<C-x><C-h>", function() require("dap.ui.widgets").hover() end)
